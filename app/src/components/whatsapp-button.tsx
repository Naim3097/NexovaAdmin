...
export function WhatsAppButton({
    ...
    name?: string | null;
    /** Show text next to the glyph (detail page); omit for the compact list button. */
    label?: string;
}) {
    const href = waHref(phone, name);
    if (!href) return null;
    return (
        <a
            href={href}
